...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        ...
        "ai":        { w: s(801, scale), h: s(1202, scale), rx: s(12, scale), ry: s(70, scale), comp: "AiPopup.qml" },
        "appmenu":   { w: s(380, scale), h: s(475, scale), rx: Math.floor((mw/2)-(s(380, scale)/2)), ry: s(70, scale), comp: "AppMenu.qml" },
        "clipboard": { w: s(380, scale), h: s(475, scale), rx: Math.floor((mw/2)-(s(380, scale)/2)), ry: s(70, scale), comp: "ClipboardMenu.qml" },
        "systemsettings": { w: s(900, scale), h: s(650, scale), rx: Math.floor((mw/2)-(s(900, scale)/2)), ry: Math.floor((mh/2)-(s(650, scale)/2)), comp: "settings/SystemSettings.qml" },
